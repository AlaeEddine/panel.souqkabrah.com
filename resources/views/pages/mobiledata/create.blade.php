            ...
            <div class="card-body">
                <div class="container">
                    <div class="card-body pt-0">
                        ...
                        @endif
                        @can('create-mobile-data')
                        <form action="{{ route('mobiledata.create.submit') }}" method="POST">
                            @csrf
                            <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12">
                                <input type="submit" formaction="{{ route('mobiledata.create.submit') }}" class="btn btn-primary mb-2" value="{{__('حفظ البيانات')}}">
                            </div>
                        </form>
                        <p><br></p>
                        @endcan
